...
func (s *Server) registerRoutes() {
	...
	s.mux.Handle("GET /api/v1/securities/search", withRequestLogging(handleSearchListings(*s.app.Securities, s.log)))
	...
	s.mux.Handle("GET /api/v1/accounts/active/", withRequestLogging(handleGetActiveAccount(*s.app.Accounts, s.log)))
}
