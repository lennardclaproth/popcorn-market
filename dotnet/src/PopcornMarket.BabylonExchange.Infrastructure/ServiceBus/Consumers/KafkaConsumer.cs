...
namespace PopcornMarket.BabylonExchange.Infrastructure.ServiceBus.Consumers;
...
internal sealed class KafkaConsumer : IConsumer, IDisposable
{
    ...
    private static readonly List<string> _topics = [TopicConstants.MarketDataPublished];
